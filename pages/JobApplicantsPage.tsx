    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <h1 className="text-3xl font-bold text-white mt-1">{job.titulo}</h1>
                        ...
                        return (
                            <Card key={app.id}>
                                <CardHeader className="flex justify-between items-start">
                                    <div>
                                        <p className="font-semibold text-white text-lg">{app.applicantName}</p>
                                ...
                                <CardContent>
                                    <p className="text-gray-300 whitespace-pre-wrap border-l-2 border-gray-700 pl-4 italic">"{app.proposalText}"</p>
                                </CardContent>
                                <div className="p-4 border-t border-gray-800 flex justify-end gap-2">
                                    <Button variant="secondary" disabled>Ver Perfil</Button>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={`Análisis de IA para ${selectedApplication?.applicantName}`}>
                {isLoading ? (
