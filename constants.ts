...
// constants.ts
import {
    LayoutDashboard, Users, BriefcaseIcon, FileTextIcon, BarChart2,
    DollarSignIcon, BookIcon, MessageSquareIcon, FileSignatureIcon, ClockIcon,
    SettingsIcon, SparklesIcon, TrendingUpIcon, Share2Icon, ShieldIcon,
    BrainCircuitIcon, ZapIcon, PlusIcon, StarIcon, SendIcon, UserIcon, Building,
    ShoppingBag, WalletIcon
...
export const SIDEBAR_STRUCTURE = [
    ...
    { type: 'group', label: 'Finanzas', icon: DollarSignIcon, items: [
        ...
        { href: '/cash-ledger', label: 'Caja y Movimientos', icon: WalletIcon },
    ]},
