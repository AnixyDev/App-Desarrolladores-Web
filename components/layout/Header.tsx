        ...
        <header className="h-20 bg-black/80 backdrop-blur-sm border-b border-gray-800 flex items-center justify-between px-4 sm:px-6 shrink-0">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg py-1 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none group-hover:pointer-events-auto">
